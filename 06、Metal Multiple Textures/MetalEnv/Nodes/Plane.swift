...
class Plane: Node {
    var vertices: [Vertex] = [
        /// 正方形1
        Vertex(position: vector3(-250,  550, 0),
               textureCoords: vector2(0, 1)), // V0 左上
        Vertex(position: vector3(-250, 50, 0),
        ...
        /// 正方形2
        Vertex(position: vector3(-250,  -50, 0),
               textureCoords: vector2(0, 1),
               textureIndex: 1), // V0 左上
        Vertex(position: vector3(-250, -550, 0),
               textureCoords: vector2(0, 0),
               textureIndex: 1), // V1 左下
        Vertex(position: vector3(250, -550, 0),
               textureCoords: vector2(1, 0),
               textureIndex: 1), // V2 右下
        Vertex(position: vector3(250,  -50, 0),
               textureCoords: vector2(1, 1),
               textureIndex: 1),  // V3 右上
    ]
    ...
    var fragmentFunctionName: String = "texture_fragment_shader"
    
    init(device: MTLDevice, imageNames: String...) {
        super.init()
...
//        commandEncoder.drawIndexedPrimitives(type: .triangle, indexCount: indices.count, indexType: .uint16, indexBuffer: indexBuffer, indexBufferOffset: 0, instanceCount: 3000)
    }
}
